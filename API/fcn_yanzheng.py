...
CN_FILE = os.path.join(BASE_DIR, 'fcn.txt')
HTTP_PLUS = os.path.join(BASE_DIR, 'fcn_http_90+.txt')
HTTP_MINUS = os.path.join(BASE_DIR, 'fcn_http_90-.txt')
HTTPS_PLUS = os.path.join(BASE_DIR, 'fcn_https_90+.txt')
HTTPS_MINUS = os.path.join(BASE_DIR, 'fcn_https_90-.txt')
CHECK_URLS = {
